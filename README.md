...
Шаг 3: Запуск основного скрипта на Сервере 1 (в той же сессии)

bash
bash reverse_proxy.sh --mode full
После установки
...
Настройки SOCKS5 на Сервере 2 остаются активными и не мешают работе каскада.
